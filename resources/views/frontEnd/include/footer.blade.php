            ...
            <div class="row g-5">
                ...
                <div class="col-6 col-lg-2">
                    ...
                    <ul class="footer-links list-unstyled">
                        ...
                        <li><a href="{{'home'}}"><i class="bi bi-chevron-right"></i> Blog</a></li>
                        <li><a href="{{'category'}}"><i class="bi bi-chevron-right"></i> Categories</a></li>
{{--                        <li><a href="{{'blog.detail'}}"><i class="bi bi-chevron-right"></i> Single Post</a></li>--}}
                    ...
                    <ul class="footer-links footer-blog-entry list-unstyled">
                        <li>
                            <a href="single-post.html" class="d-flex align-items-center">
                                <img src="{{asset('frontEndAsset')}}/assets/img/post-sq-1.jpg" alt=""
                        ...
                        <li>
                            <a href="single-post.html" class="d-flex align-items-center">
                                <img src="{{asset('frontEndAsset')}}/assets/img/post-sq-2.jpg" alt=""
                                     class="img-fluid me-3">
                                <div>
                                    <div class="post-meta d-block"><span class="date">Culture</span> <span class="mx-1">&bullet;</span>
                                        <span>Jul 5th '22</span></div>
                        ...
                        <li>
                            <a href="single-post.html" class="d-flex align-items-center">
                                <img src="{{asset('frontEndAsset')}}/assets/img/post-sq-3.jpg" alt=""
                                     class="img-fluid me-3">
                                <div>
                                    <div class="post-meta d-block"><span class="date">Culture</span> <span class="mx-1">&bullet;</span>
                                        <span>Jul 5th '22</span></div>
                        ...
                        <li>
                            <a href="single-post.html" class="d-flex align-items-center">
                                <img src="{{asset('frontEndAsset')}}/assets/img/post-sq-4.jpg" alt=""
                                     class="img-fluid me-3">
                                <div>
                                    <div class="post-meta d-block"><span class="date">Culture</span> <span class="mx-1">&bullet;</span>
                                        <span>Jul 5th '22</span></div>
