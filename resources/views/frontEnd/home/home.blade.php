                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <a href="single-post.html" class="img-bg d-flex align-items-end"
                                   style="background-image: url('{{asset('frontEndAsset')}}/assets/img/post-slide-1.jpg');">
                            ...
                            <div class="swiper-slide">
                                <a href="single-post.html" class="img-bg d-flex align-items-end"
                                   style="background-image: url('{{asset('frontEndAsset')}}/assets/img/post-slide-2.jpg');">
                                    <div class="img-bg-inner">
                            ...
                            <div class="swiper-slide">
                                <a href="single-post.html" class="img-bg d-flex align-items-end"
                                   style="background-image: url('{{asset('frontEndAsset')}}/assets/img/post-slide-3.jpg');">
                                    <div class="img-bg-inner">
                            ...
                            <div class="swiper-slide">
                                <a href="single-post.html" class="img-bg d-flex align-items-end"
                                   style="background-image: url('{{asset('frontEndAsset')}}/assets/img/post-slide-4.jpg');">
                                    <div class="img-bg-inner">
            ...
            <div class="row g-5">
                <div class="col-lg-4">
                    <div class="post-entry-1 lg">
                        <a href="single-post.html"><img src="{{asset('frontEndAsset')}}/assets/img/post-landscape-1.jpg"
                        ...
                        <div class="d-flex align-items-center author">
                            <div class="photo"><img src="{{asset('frontEndAsset')}}/assets/img/person-1.jpg" alt=""
                                                    class="img-fluid"></div>
                            <div class="name">
                                ...
                                @if($loop->iteration % 2 == 1)
                                    <div class="post-entry-1">
                                        <a href="{{route('blog.detail',['slug' => $blog->slug])}}"><img
                                                src="{{$blog->image}}" alt="" style="height: 280px; width: 330px"
                                                class="img-fluid"></a>
                                        <div class="post-meta"><span class="date">{{$blog->category_name}}</span> <span
                                                class="mx-1">&bullet;</span> <span>{{$blog->date}}</span></div>
                                    ...
                                    @if($loop->iteration % 2 == 0)
                                        <div class="post-entry-1">
                                            <a href="{{route('blog.detail',['slug' => $blog->slug])}}"><img
                                                    src="{{$blog->image}}" alt="" style="height: 280px; width: 330px"
                                                    class="img-fluid"></a>
                                            <div class="post-meta"><span class="date">{{$blog->category_name}}</span>
                                                <span
                                                    class="mx-1">&bullet;</span> <span>{{$blog->date}}</span></div>
                                            <h2><a href="{{route('blog.detail',['slug' => $blog->slug])}}">{{$blog->title}}</a></h2>
                                        </div>
                ...
                <div class="col-md-9">
                    ...
                    <div class="d-lg-flex post-entry-2">
                        <a href="single-post.html" class="me-4 thumbnail mb-4 mb-lg-0 d-inline-block">
                            <img src="{{asset('frontEndAsset')}}/assets/img/post-landscape-6.jpg" alt=""
                                 class="img-fluid">
                        </a>
                        <div>
                            <div class="post-meta"><span class="date">Culture</span> <span class="mx-1">&bullet;</span>
                            ...
                            <div class="d-flex align-items-center author">
                                <div class="photo"><img src="{{asset('frontEndAsset')}}/assets/img/person-2.jpg" alt=""
                                                        class="img-fluid"></div>
                                <div class="name">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="post-entry-1 border-bottom">
                                <a href="single-post.html"><img
                                        src="{{asset('frontEndAsset')}}/assets/img/post-landscape-1.jpg" alt=""
                                        class="img-fluid"></a>
                        ...
                        <div class="col-lg-8">
                            <div class="post-entry-1">
                                <a href="single-post.html"><img
                                        src="{{asset('frontEndAsset')}}/assets/img/post-landscape-2.jpg" alt=""
                                        class="img-fluid"></a>
                                <div class="post-meta"><span class="date">Culture</span> <span
                                        class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                ...
                <div class="col-md-9 order-md-2">
                    ...
                    <div class="d-lg-flex post-entry-2">
                        <a href="single-post.html" class="me-4 thumbnail d-inline-block mb-4 mb-lg-0">
                            <img src="{{asset('frontEndAsset')}}/assets/img/post-landscape-3.jpg" alt=""
                                 class="img-fluid">
                        </a>
                        <div>
                            ...
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio placeat
                                ...
                                deserunt aliquam temporibus sapiente, laudantium dolorum itaque libero eos deleniti?</p>
                            <div class="d-flex align-items-center author">
                                <div class="photo"><img src="{{asset('frontEndAsset')}}/assets/img/person-4.jpg" alt=""
                                                        class="img-fluid"></div>
                                <div class="name">
                                    <h3 class="m-0 p-0">Wade Warren</h3>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="post-entry-1 border-bottom">
                                <a href="single-post.html"><img
                                        src="{{asset('frontEndAsset')}}/assets/img/post-landscape-5.jpg" alt=""
                                        class="img-fluid"></a>
                        ...
                        <div class="col-lg-8">
                            <div class="post-entry-1">
                                <a href="single-post.html"><img
                                        src="{{asset('frontEndAsset')}}/assets/img/post-landscape-7.jpg" alt=""
                                        class="img-fluid"></a>
                                <div class="post-meta"><span class="date">Business</span> <span
                                        class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                                <h2 class="mb-2"><a href="single-post.html">How to Avoid Distraction and Stay Focused
    ...
    <section class="category-section">
        <div class="container" data-aos="fade-up">
            ...
            <div class="row g-5">
                <div class="col-lg-4">
                    <div class="post-entry-1 lg">
                        <a href="single-post.html"><img src="{{asset('frontEndAsset')}}/assets/img/post-landscape-8.jpg"
                                                        alt="" class="img-fluid"></a>
                        ...
                        <div class="d-flex align-items-center author">
                            <div class="photo"><img src="{{asset('frontEndAsset')}}/assets/img/person-7.jpg" alt=""
                                                    class="img-fluid"></div>
                            <div class="name">
                ...
                <div class="col-lg-8">
                    <div class="row g-5">
                        <div class="col-lg-4 border-start custom-border">
                            <div class="post-entry-1">
                                <a href="single-post.html"><img
                                        src="{{asset('frontEndAsset')}}/assets/img/post-landscape-6.jpg" alt=""
                                        class="img-fluid"></a>
                            ...
                            <div class="post-entry-1">
                                <a href="single-post.html"><img
                                        src="{{asset('frontEndAsset')}}/assets/img/post-landscape-4.jpg" alt=""
                                        class="img-fluid"></a>
                                <div class="post-meta"><span class="date">Lifestyle</span> <span
                        ...
                        <div class="col-lg-4 border-start custom-border">
                            <div class="post-entry-1">
                                <a href="single-post.html"><img
                                        src="{{asset('frontEndAsset')}}/assets/img/post-landscape-3.jpg" alt=""
                                        class="img-fluid"></a>
                                <div class="post-meta"><span class="date">Lifestyle</span> <span
                                        class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
